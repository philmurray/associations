...
.constant('NORMAL_RANGE_TEXT', [
	'You are not human.  You are likely either an alien, or some kind of mutant vegetable that has gained consciousness and the ability to type.  Or you may just be the next step in human evolution and are waiting for the rest of the world to catch up.',
	'You exist on the fringes of society.  You can\'t understand the rest of the world, and they don\'t understand you.  You probably surround yourself with a small group of like minded individuals and rarely interact with people outside it.  This group may be a network of conspiracy theorists, an extreemist religous cult, or travelling circus.',
	'You are kind of a weirdo.  You see the world in a different way than most other people.  You are still able to function in normal society, but have probably always felt that you don\'t quite fit in.  You probably have a passion that you don\'t share with others until you really get to know them.  Like LARPing or collecting antique toilet plungers.',
